...
/**
 * Convenience wrapper around {@link Log}, which evaluates the current log level of
...
public final class Logger {
    ...
    /**
     * The core interface of {@link Log}, converted into instance methods so as to
    ...
    /**
     * Default {@link LogWrapper} implementation, using {@link Log} static methods.
     */
